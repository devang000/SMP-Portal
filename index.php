...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["password"])) {
        ...
        $sql = "SELECT id, photo, firstname, society, lastname, phone_number, dob, flatNo, address, city, pincode, password FROM residents WHERE email = ?";
...
<body>
    ...
    <section id="Logins">
        ...
        <div class="container" style="margin-top: 40px;">
            <label for="societySelect" style="font-family: poppins; font-weight: 500;">Select Your Society:</label>
            <div class="row">
                <div class="col">
                    <select class="form-control" id="societySelect" name="society">
                        <option value="" selected>Search your society</option>
                        <option value="1">Register your society</option>
                        <?php
                ...
                <div>
                    <button type="button" id="goButton" class="btn btn-outline-primary rounded-1 go">Go</button>
                </div>
            </div>
        </div>
        ...
        <script>
            document.getElementById('goButton').addEventListener('click', function() {
                var selectedValue = document.getElementById('societySelect').value;
                if (selectedValue === "") {
                    alert("Please select a society to proceed.");

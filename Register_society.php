...
// Check if the 'price' parameter is set in the URL
if (isset($_GET['price'])) {

    // Set the 'price' parameter value in the session variable
                            ...
                            <div class="col-md-12">
                                <div class="container">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input maxlength="100" type="text" required="required" class="form-control" placeholder="Enter your society name" id="societyName">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea required="required" class="form-control" placeholder="Enter your society address" id="societyAddress"></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input maxlength="100" type="text" required="required" class="form-control" placeholder="Enter city" id="city">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input maxlength="100" type="text" required="required" class="form-control" placeholder="Enter pincode" id="pincode">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <input type="file" id="logoInput" required="required" onchange="previewLogo(event)" />
                                    ...
                                    <button class="btn btn-primary nextBtn pull-right w-25 mt-3" type="button">Next</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input maxlength="100" type="text" required="required" class="form-control" placeholder="Enter phone number" id="phoneNumber">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input maxlength="100" type="password" required="required" class="form-control" placeholder="Enter password" id="password">
                                            <span class="error-message" id="passwordError" style="display: none; color: red;">*Password is required</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <button class="mt-3 btn btn-primary nextBtn pull-right" style="width: 100px; margin-left:10px;" type="button">Next</button>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validatePassword(passwordInput, passwordError) {
                ...
                if (passwordInput.value.trim() === "") {
                    ...
                    passwordError.textContent = "*Password must be at least 8 characters long, contain one uppercase letter, one lowercase letter, one numeric digit, one special character, and one alphabetical character";
                    passwordError.style.display = 'block';
                    passwordInput.classList.add("is-invalid");
                    return false;
                } else {
